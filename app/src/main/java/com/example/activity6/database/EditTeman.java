...
public class EditTeman extends AppCompatActivity {
    ...
    private static String url_update = "https://20200140094.praktikumtiumy.com/updatetm.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edTelepon = findViewById(R.id.edTelp);
...
//        tlp = bundle.getString("kunci3");
    ...
    public void EditData()
    {
        ...
        telponEd = edTelepon.getText().toString();
